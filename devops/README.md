...
DEPLOY_ENV=prod
DEPLOY_HOST=cms.irontree.co.kr
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for cms.irontree.co.kr, enable SSH, and install a supported version of Python 3 on that system.
...
Deploy the stack defined in `devops/stacks/cms.irontree.co.kr.yml` to the remote server with:
